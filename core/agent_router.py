...
SURFACE_GUIDANCE = (
    ...
    "the way in), so pick it early rather than grinding the host's IIS first. A Windows host "
    "exposing only SMB/RPC (445/135/139) with no Kerberos (88) or LDAP (389) is NOT a domain "
    "controller — treat it as an ordinary SMB target, not an AD surface. "
